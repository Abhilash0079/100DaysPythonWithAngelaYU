...
STOCK_API_KEY = "*******WAS****IQD*****"
NEWS_API_KEY = "**d7154*****de6e***051*"

TWILIO_SID = "******672e*****5f9fbe4***"
TWILIO_TOKEN = "****302*****bf82**cdb9dc"
...
# to send a separate message with each article's title and description to your phone number.
    ...
    formatted_articles = [(f"{STOCK_NAME}: {up_down}{abs(diff_percentage)}%Headline: {article['title']}.\nBrief: {article['description']}") for article in three_articles]
